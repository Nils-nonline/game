var fileNames = {
	...
	"FBX/AssaultRifle_02.fbx": {
		scale: 0.004, tx: 90, ty: 0, tz: 0, name: "M4", publicinf: {
			name: "M4", //checked
			repeated: true,
			mag: 30,
			reloadtime: 1600,
	...
	"FBX/fn-scar.fbx": {
		scale: 0.002, tx: 0, ty: 0, tz: 0, name: "herstal 762", publicinf: {
	...
	"FBX/SniperRifle_02.fbx": {
		scale: 0.0025, tx: 0, ty: 0, tz: 0, name: "sniper", publicinf: {
			name: "Sniper",
			repeated: false,
			cooldown: 2000,
			damage: 1000
	...
	"FBX/Shotgun_03.fbx": {
		scale: 0.0025, tx: 0, ty: 0, tz: 0, name: "shotgun", publicinf: {
			name: "Shotgun",
			repeated: true,
			cooldown: 1000,
			damage: 500
	...
	"FBX/SubmachineGun_02.fbx": {
		scale: 0.0025, tx: 0, ty: 0, tz: 0, name: "smg", publicinf: {
			name: "SMG",
			repeated: true,
			cooldown: 200,
			damage: 100
